 ...
 * @author rnr
 *
 *LoginForm extends ActionForm class and acts as a form Bean.
 *Helps in data transfer from the UI screen to the Action class and from Action Class to UI.
 *Validate method is used to perform data validations.
